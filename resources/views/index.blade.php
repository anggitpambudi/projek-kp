...
<head>
    ...
    <title>Winance - Win Your Future Financial</title>
    <!-- Favicon-->
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container px-5">
            <a class="navbar-brand" href="#!">WINANCE</a>
                    ...
                    @auth
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item" href="/profile/{{auth()->user()->id}}">Setting</a></li>
                                <li>
    ...
    <!-- Header-->
    <header class="bg-image" style="background-image: url({{ asset('img/chart.jpg') }})">
        <div class="container px-5">
            <div class="row gx-5 justify-content-center">
                <div class="col-lg-6">
                    <div class="text-center my-5">
                        <h1 class="display-5 fw-bolder text-white mb-2">How to get started on saving and investing in
                            your future</h1>
                        <p class="lead text-white-50 mb-4">If you don’t learn to manage your money, then other people
                            will find ways to mismanage it for you.</p>
                    ...
                    <div class="card mb-4">
                        <div class="card-body p-4">
                            <div class="d-flex">
                                ...
                                <div class="ms-4">
                                    <p class="mb-1">Thank you for putting together such a great product. We
                                        loved working with you and the whole team, and we will be recommending you to
                                        others!</p>
